...
\begin{table}[h!]
  ...
  \begin{tabular}{|c|c|c|c|c|c|c|c|}
    \hline
    \textbf{Arriskuaren IDa} & \textbf{Arriskuaren deskribapena} & \textbf{Probabilitatea} & \textbf{Inpaktoa} & \textbf{Arriskua ($ P \times I $)} & \textbf{Kategoria} & \textbf{Arrisku adierazle nagusiak} & \textbf{Konponbide adierazleak} \\ \hline
  \end{tabular}
